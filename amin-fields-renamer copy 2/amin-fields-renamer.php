...
if (!function_exists('renamer_default_options')) {
  function renamer_default_options() {
    if (get_option('renamer_options') === false) {
      $new_options['custom_text'] = 'Blah blah blah';
      add_option('renamer_options',$new_options);
    }
  }
}

//execute the option into the code
?>
